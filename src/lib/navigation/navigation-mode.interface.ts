...
export interface NavigationMode {
   ...
   */
  canGoToStep(wizard: IWizardNavigation, destinationIndex: number): Promise<boolean>;
   ...
   */
  isNavigable(wizard: IWizardNavigation, destinationIndex: number): boolean;
   ...
   * @param wizard The wizard component to operate on
   */
  reset(wizard: IWizardNavigation): void;
}
